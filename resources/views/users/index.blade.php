...
<div class="px-6 mb-4">
    <div class="flex justify-between mb-1">
        <div class="flex flex-row gap-4">
            <h1 class="text-3xl font-bold mt-4 mb-2">Utilisateurs</h1>
            <a href="{{route("users.create")}}" class="rounded-3xl mt-3 mb-2 px-2 pt-2 text-sm font-medium hover:-translate-y-1 transition-all">
