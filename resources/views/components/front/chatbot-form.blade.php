<div id="chatbot" class="hidden fixed bottom-24 overflow-auto max-h-[400px] right-5 w-[550px] bg-white border border-gray-300 shadow-lg rounded-lg p-5">
    <form id="chatbot-form">
        ...
        <div class="block flex items-center w-full rounded-md border-0  text-gray-900 mb-2">
            <input type="text" name="query" id="chatbot-input" placeholder="Tapez ici..." autocomplete="off" class=" rounded-md max-w-full flex-1 focus:border-none py-2 px-3.5  shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-black/50">
